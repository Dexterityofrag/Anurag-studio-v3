...
.pe__input:focus { border-color: #C8FF00; }
.pe__textarea {
  resize: vertical;
  min-height: 80px;
}
...
.pe__switch--on { background: #C8FF00; }
.pe__switch__knob {
  position: absolute;
  top: 3px;
  left: 3px;
...
.pe__toolbar-btn--active { background: #262626; color: #C8FF00; }
...
.pe__editor-content .tiptap blockquote { border-left: 3px solid #C8FF00; padding-left: 16px; color: #8A8A8A; font-style: italic; margin: 1em 0; }
.pe__editor-content .tiptap a { color: #C8FF00; }
