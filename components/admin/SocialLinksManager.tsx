...
.sl__input:focus { border-color: #C8FF00; }
...
.sl__toggle--on { background: #C8FF00; }
.sl__toggle__knob {
  position: absolute;
  top: 2px; left: 2px;
...
.sl__icon-btn--save:hover { color: #C8FF00; }
        ...
        <tr key={row.id ?? 'new'}>
            ...
            <td>
                {isEditing ? (
                    ...
                    <span style={{ color: link?.isVisible ? '#C8FF00' : '#8A8A8A', fontFamily: 'var(--font-mono)', fontSize: 11 }}>
