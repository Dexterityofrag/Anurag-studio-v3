...
.ped__input:focus { border-color: #00FF94; }
.ped__textarea {
  resize: vertical;
  min-height: 80px;
}
...
.ped__switch--on { background: #00FF94; }
.ped__switch__knob {
  position: absolute;
  top: 3px;
  left: 3px;
...
.ped__toolbar-btn--active { background: #262626; color: #00FF94; }
...
.ped__editor-content .tiptap blockquote { border-left: 3px solid #00FF94; padding-left: 16px; color: #8A8A8A; font-style: italic; margin: 1em 0; }
.ped__editor-content .tiptap a { color: #00FF94; }
